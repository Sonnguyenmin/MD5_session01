          ...
          <div className="container">
            <div className="row">
              {product.map((item, index) => {
                return <Iphone key={index} item={item} />;
              })}
            </div>
          </div>
        </div>
            ...
            <div className="row">
              ...
              <div className="col-md-3 col-sm-6">
                <div className="footer-newsletter">
                  ...
                  <p>
                    Sign up to our newsletter and get exclusive deals you wont find anywhere else straight to your
                    inbox!
                  </p>
